...
define(['./workbox-8c5d9594'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.7q0v95e0e44"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/\/api\/(standings|fixtures)/, new workbox.StaleWhileRevalidate({
  ...
  workbox.registerRoute(/\/api\/players/, new workbox.CacheFirst({
